          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            <Nav className="me-auto">
              <NavDropdown title="Clothing" id="basic-nav-dropdown">
                ...
                <NavDropdown.Item href="#action/3.3">Gowns</NavDropdown.Item>
                <NavDropdown.Divider />
            ...
            <Nav className="me-auto">
              <NavDropdown title="Perfumes" id="basic-nav-dropdown">
                <NavDropdown.Item href="#action/3.1">Action</NavDropdown.Item>
                <NavDropdown.Item href="#action/3.2">
                  Another action
                </NavDropdown.Item>
            ...
            <Nav className="me-auto">
              <NavDropdown title="Footwears" id="basic-nav-dropdown">
                <NavDropdown.Item href="#action/3.1">Action</NavDropdown.Item>
                <NavDropdown.Item href="#action/3.2">
                  Another action
                </NavDropdown.Item>
            ...
            <Nav className="me-auto">
              <NavDropdown title="Feminism" id="basic-nav-dropdown">
                <NavDropdown.Item href="#action/3.1">Action</NavDropdown.Item>
                <NavDropdown.Item href="#action/3.2">
                  Another action
                </NavDropdown.Item>
